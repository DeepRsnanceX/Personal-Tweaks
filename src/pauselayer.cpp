...
class $modify(MyPauseLayer, PauseLayer) {
    ...
    void customSetup() {
        ...
        auto spr = CCSprite::create("LaVerdadMeDaMuchaPutaHuevaAprenderAUsarElCosoQueHaceUnBotonConDosCapasLanfao.png"_spr);
        ...
        btn->setID("personaltweaks-settings-shortcut"_spr);
        menu->addChild(btn);
        menu->updateLayout();
    }
};
